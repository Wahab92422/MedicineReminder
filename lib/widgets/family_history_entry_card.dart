...
class FamilyHistoryEntryCard extends StatelessWidget {
  const FamilyHistoryEntryCard({
    super.key,
    required this.entry,
    required this.onTap,
    this.onDelete,
  ...
  final FamilyHistoryEntry entry;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            localizations.formatMediumDate(entry.recordedAt),
