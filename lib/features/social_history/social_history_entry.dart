...
class SocialHistoryEntry {
  ...
  factory SocialHistoryEntry.fromFirestore(
    DocumentSnapshot<Map<String, dynamic>> doc,
  ) {
    return SocialHistoryEntry.fromMap(doc.id, doc.data() ?? const {});
  }

  factory SocialHistoryEntry.fromMap(String id, Map<String, dynamic> map) {
